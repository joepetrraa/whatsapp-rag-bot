...
class RAGEngine {
  ...
  buildRagIndex(documents) {
    ...
    const vectors =
      tokenizedDocs.map((tokens, idx) => {

        const tf =
          this.buildTfMap(tokens);
